  ...
  return <div className="min-h-screen bg-background pb-32">
      ...
      <div className="px-4 py-3">
        <div className="flex w-full items-stretch rounded-xl h-12">
          ...
          <Input placeholder="Buscar" className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-foreground focus:outline-0 focus:ring-0 border-none bg-muted focus:border-none h-full placeholder:text-muted-foreground px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} />
        </div>
      </div>
